...
public class PopulationManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            GameObject b = Instantiate(botPrefab, startingPos.transform.position, Quaternion.Euler(0, -45f, 0));
    ...
    {
        List<GameObject> sortedList = population.OrderBy(o => (o.GetComponent<CarBrain>().distanceTravelled)).ToList();
